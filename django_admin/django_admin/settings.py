...
SECRET_KEY = 'g6$=olkg8io@*mu&e3-ie(zo6bb1!%%%uat(hogooq_pc(4xnx'
...
MIDDLEWARE = [
    ...
    'core_ext.middleware.LogMiddleware',  # 访问记录中间件
    'core_ext.middleware.OpenAPILogMiddleware',  # OpenAPI日志记录中间件
    'core_ext.debug_tools.middleware.DebugMiddleware',  # debug中间件
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_DATABASE', env('DB_DATABASE')),
